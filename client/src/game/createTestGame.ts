import type { GameState, BoardMap, Unit } from '../types'
...
export function createTestGame(): GameState {
  ...
  const zaku2: Unit = {
    ...
    traits: ['Zeon', 'Ace'],
    maxHp: 4, vp: 3, startingTl: 3,
    currentHp: 4, energy: 0,
    position: p2Coord,
    weapons: [
  ...
  return {
    ...
    players: {
      player1: {
        id: 'player1', name: 'Amuro Ray', vp: 0,
        tactics: { deck: [], hand: [], discarded: [], usedResponseThisTurn: false },
        squadUnitIds: ['rx78'],
      },
      player2: {
        id: 'player2', name: 'Char Aznable', vp: 0,
        tactics: { deck: [], hand: [], discarded: [], usedResponseThisTurn: false },
        squadUnitIds: ['zaku2'],
      },
    },
